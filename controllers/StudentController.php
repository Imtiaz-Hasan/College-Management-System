<?php
      ...
      if($_SERVER["REQUEST_METHOD"]=="POST")
    {
			...
			editStudent($_GET["id"],$name,$uname,$pass,$cpass,$deprt,$mail,$phone,$date,$gender);
		 ...
		 function editStudent($id,$name,$uname,$pass,$cpass,$deprt,$mail,$phone,$date,$gender){
		$query = "update student set name='$name',username='$uname',password='$pass',confirmpassword='$cpass',department='$deprt',email='$mail',phone='$phone',date='$date',gender='$gender' where id=$id;";
	execute($query);
	...
	$query = "INSERT INTO student VALUES (NULL,'$name','$uname','$pass','$cpass','$deprt','$mail','$phone','$date','$gender','student')";
	execute($query);
	...
	function checkStudent($key){
		$query = "select name,id from student where name like '%$key%'";
