...
<html>
    <head>
        ...
        <fieldset style ="width:500px">
            <legend><h1>Add Assignment</h1></legend>
				 ...
				 <form action="" onsubmit="return validate()" method="post">
				  ...
				  <div class="form-group text-right">
			        ...
			        <button><a href="view assignment_tr.php"  class="button">View </a></button>
			     </div>
				...
				<table>
                    ...
                    <tr>
                        <td><span>Assignment Title:</span></td>
				...
				<tr>
					...
					<td><input type="submit" name="addassignment" value="submit"></td>
				</tr>
        ...
        <script src="js/assignmentValidation_tr.js"></script>
