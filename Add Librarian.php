...
<html>
  <head>
     ...
     <body>
        ...
        <div class="center-login">
            <legend><h1>  Add Librarian</h1></legend>
            ...
            <form action="" onsubmit="return validate()" method="post" >
                <table>
					...
					<div class="form-group text-right">	
                       <td> <input type="submit" name="addlibrarian" class="btn btn-primary" value="submit" ></td>
  ...
  <script src="js/AddLibrarianValidation.js"></script>
